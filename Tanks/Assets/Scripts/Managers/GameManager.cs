    ...
    private void SpawnAllTanks()
    {
        ...
        for (int i = 0; i < m_Tanks.Length; i++)
        {
            ...
            if(i == 0){
                ...
                //Instantiate(tank1, m_Tanks[i].m_SpawnPoint.position, m_Tanks[i].m_SpawnPoint.rotation) as GameObject;
                ...
                //m_Tanks[i].m_Instance =
                //Instantiate(Tank2, m_Tanks[i].m_SpawnPoint.position, m_Tanks[i].m_SpawnPoint.rotation) as GameObject;
